                                    ...
                                    if (h.hasClass("gh")) {
                                        ...
                                        nt.each(function(t) {
                                            ...
                                            0 === t && st.set($(this), {
                                                ...
                                                a(t - 1)
                                            }, rt.to(it, .8, i), rt.to({}, .2, {}), st.set($(this), {
                                                zIndex: 1
                                            }), n[e] = "+=100%", st.to(h, 1, n), r[e] = "+=50px", K.to(l, .5, r)), rt.to(it, .8, {
                                                left: "50%",
                                                ease: Power4.easeInOut,
                                                delay: .2
                                            }), s[e] = "-=100%", st.to(h, 1, s), st.set($(this), {
                                                zIndex: -1
                                        ...
                                        var ot = new ScrollMagic.Scene({
                                                ...
                                                triggerHook: "onLeave",
                                                duration: et
                                            }).setTween(rt).setPin(h[0]).addTo(a),
                                            B = new ScrollMagic.Scene({
                                                triggerElement: h[0],
                                                triggerHook: "onLeave",
                                                duration: et
                                        ...
                                        var at = i(u, "100%"),
                                            lt = h.innerHeight() - window.innerHeight,
